...
public class Metadata {
    ...
    public static void main(String[] args) {
        ...
        Replacer r1 = new Replacer("default");
        Replacer r2 = new Replacer("default");
        es.execute(r1);
        es.execute(r2);
        es.shutdown();
    }
        ...
        public void run() {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                if (replaced) {
                    ...
                    System.out.println(String.format("[%s] Failed to replace, justing just put", threadName));
                    cache.put(KEY, VALUE_PREXIF + i);
                    System.out.println(String.format("[%s] Stored with version %d", threadName, cache.getWithMetadata(KEY).getVersion()));
                }
            }
